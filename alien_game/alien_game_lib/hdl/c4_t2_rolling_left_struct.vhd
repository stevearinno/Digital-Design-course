...
END c4_t2_rolling_left ;

--
-- VHDL Architecture alien_game_lib.c4_t2_rolling_left.struct
--
-- Created:
--          by - wirdatma.UNKNOWN (HTC219-704-SPC)
--          at - 14:05:55  5.11.2019
--
-- Generated by Mentor Graphics' HDL Designer(TM) 2019.3 (Build 4)
--
LIBRARY ieee;
...
ARCHITECTURE struct OF c4_t2_rolling_left IS
...
BEGIN
   ...
   bits_out <= dout6 & dout5 & dout4 & dout3 & dout2 & dout1 & dout0 & dout7;

   -- ModuleWare code(v1.12) for instance 'U_0' of 'split'
   mw_U_0temp_din <= bits_in;
