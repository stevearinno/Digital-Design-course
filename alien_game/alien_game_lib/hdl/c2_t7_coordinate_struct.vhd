...
ARCHITECTURE struct OF c2_t7_coordinate IS
   ...
   SIGNAL out_left_shift1 : std_logic_vector(7 DOWNTO 0);
...
BEGIN
   ...
   u_20combo_proc: PROCESS(y_coord_internal, out_left_shift1, hit)
   BEGIN
      CASE hit IS
      WHEN '0' => dout2 <= y_coord_internal;
      WHEN '1' => dout2 <= out_left_shift1;
   ...
   U_21 : c2_t3_left_shifter
      PORT MAP (
         ...
         out_left_shift => out_left_shift1
      );
